...
---
### ER図
<img src="er_figure.png" width="50%">

### 本サービスの概要（700文字以内）
(694文字)
* 「本気ではない」アイデアを投稿・評価し合いアイデアの質の向上を手助けするサイト
  * アプリ開発のアイデアに困っている人々に、気軽にアイデアの共有およびフィードバックを得る機会を提供する
* ユーザー層は年齢・性別を問わず、アプリ開発のアイデアに困っている人や新しい視点を得たい方が対象
* アプリのアイデア以外の投稿も混在している従来のSNSやブログではアイデアのネタ探しが大変な点を問題と捉え、アプリのアイデアに特化して投稿を募っている点が他のサービスとの差異ポイントとしている
* 他の投稿からインスピレーションを得た場合は、引用元を示す引用投稿が可能とする
* 差異化ポイントとしては、没になるはずだったような質の低いアイデアを気軽に評価・参考にしてもらえる点
  * KJ法やブレーンストーミングのような従来のアイデア創出手法と比べ、労力をかけずに新しい視点のアイデアの閲覧やアイデアの精査が可能
  * 生成AIでは生み出しにくい「外れ値」的なアイデアも期待できる
* 用途とジャンルを指定可能にすることで、特定のジャンルに関するアイデアを閲覧しやすくする
  * 無作為ランダム表示欄を設けることで、異なるジャンルのアイデアにも触れられるようにする
* スタンプ機能やコメント機能を通じて、フィードバックを得られる仕組みも整える
  * ユーザー同士のフォロー機能やスタンプ数、コメント数の集計表示、コメントへの「いいね機能」など、コミュニティ感を醸成し、継続的な参加意欲を高める仕組みも導入する
  * スタンプやコメント機能を通じてフィードバックを得ることで、互いに刺激し合いながらアイデアの質を向上させる機会を提供
