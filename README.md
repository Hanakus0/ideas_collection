...
| フォロー&フォロー解除  |  |
| :-- | :-- | 
| ![DemoGifFromGyazo5](https://gyazo.com/a51965b5fbdeede17fbba2d5bd59ebbd/raw) | ![DemoGifFromGyazo6](/raw) |
| 投稿のブックマーク以外にもユーザのフォローも可能となっています <br> ブックマークのようにフォローしたユーザーだけを一覧表示できるので、特定のユーザーのアイデアを追うことも簡単にしております <br> フォローの解除も可能です |  |
<br>
